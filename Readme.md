...
### FIXES
- [ ] when monster steps on squeaky board, but out of sight, do not reveal itself
- [ ] show the full wave propagation, even in hidden space (useful to get a sense of where the action is taking place)
- [ ] cancel auto-walk when hear the sound wave (and/or make this an option)
